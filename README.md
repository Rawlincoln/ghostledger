...
| [Deploy on Render](https://render.com/deploy?repo=https://github.com/Rawlincoln/ghostledger) | Free plan. Pages are static files, so a cold start does not wait on the app server. |
